...
sql = "SELECT delngDe as Date, aucSeNm as TradeType, whsalMrktNewNm as Market, insttNewNm as Agent, shipmntSeNm as ShippingType, stdMtcNewNm as Origin, stdSpciesNm as Species, stdFrmlcNewNm as Package, delngPrut as Unit, stdQlityNewNm as Grade, delngQy as Quantity, sbidPric as Price, INTEGER(CEIL(sbidPric / FLOAT(delngPrut))) as UnitPrice FROM  [pricespectrum-159700:auction_price.realtime] WHERE stdPrdlstNewCode = '0909' AND RAND() < 0.05 LIMIT 1000"
